...
model_randforest = pickle.load(open('model_randforest.pkl', 'rb'))
...
def predict():
    ...
    prediction_randforest = "RandomForestClassifier: "+ model_randforest.predict(data)
    ...
    return render_template('index.html',prediction_text="Below are prediction results: ", prediction_text_logreg=prediction_logreg, prediction_text_knn=prediction_knn,prediction_text_svn=prediction_svm, prediction_text_dectree=prediction_dectree, prediction_text_randforest=prediction_randforest)
